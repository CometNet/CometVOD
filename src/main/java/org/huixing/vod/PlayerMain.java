...
public class PlayerMain {
    ...
    public static void main(String[] args) {
        ...
        NativeLibrary.addSearchPath(RuntimeUtil.getLibVlcLibraryName(), "D:\\Program Files\\VideoLAN\\vlc-3.0.4\\sdk\\lib"); // 导入的路径是vlc的安装路径
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String mrl = new HttpMrl().host("img.ksbbs.com/")
                            .port(80)
                            .path("/asset/Mon_1703/eb048d7839442d0.mp4")
                            .value();
